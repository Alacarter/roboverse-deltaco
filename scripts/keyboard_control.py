...
KEY_TO_ACTION_MAPPING = {
    bullet.p.B3G_LEFT_ARROW: np.array([0.1, 0, 0, 0, 0, 0, 0, 0]),
    bullet.p.B3G_RIGHT_ARROW: np.array([-0.1, 0, 0, 0, 0, 0, 0, 0]),
    bullet.p.B3G_UP_ARROW: np.array([0, -0.1, 0, 0, 0, 0, 0, 0]),
    bullet.p.B3G_DOWN_ARROW: np.array([0, 0.1, 0, 0, 0, 0, 0, 0]),
    ord('j'): np.array([0, 0, 0.2, 0, 0, 0, 0, 0]),
    ord('k'): np.array([0, 0, -0.2, 0, 0, 0, 0, 0]),
    ord('h'): np.array([0, 0, 0, 0, 0, 0, -0.7, 0]),
    ord('l'): np.array([0, 0, 0, 0, 0, 0, 0.7, 0])
}
