...
CONTAINER_CONFIGS = {
    ...
    'low_tray_big_half_green': {
        'container_position_low': (.5, 0.25, -.30),
        'container_position_high': (.7, 0.25, -.30),
        'container_position_default': (.52, 0.32, -.30),
        'container_orientation': (0, 0, 0.707107, 0.707107),
        'container_scale': 0.18,
        'container_position_z': -0.37,
        'place_success_height_threshold': -0.32,
        'place_success_radius_threshold': 0.04,
        'half_extents': (0.075, 0.0525),
        'min_distance_from_object': 0.11,
    },
    'low_tray_big_half_red': {
        'container_position_low': (.5, 0.25, -.30),
        'container_position_high': (.7, 0.25, -.30),
        'container_position_default': (.52, 0.18, -.30),
        'container_orientation': (0, 0, 0.707107, 0.707107),
        'container_scale': 0.18,
        'container_position_z': -0.37,
        'place_success_height_threshold': -0.32,
...
OBJ_RENAME_MAP = {
    'bathtub': 'curved tray',
    'flowery_half_donut': 'toroid',
    't_cup': 'water jug',
    'cookie_circular_lidless_tin': 'bamboo lid',
    'box_sofa': 'brick',
    'two_layered_lampshade': 'lampshade',
    'conic_bin': 'trash can',
    # 'jar': 'blue jar',
}
...
OBJECT_SCALINGS = {
    ...
    't_cup': 0.5,
    'cookie_circular_lidless_tin': 0.4,
    'box_sofa': 0.4,
    'baseball_cap': 0.5,
    'two_layered_lampshade': 0.45,
...
OBJECT_ORIENTATIONS = {
    ...
    'bathtub': (0, 0.707, 0, 0.707), # (0, 0, 1, 0),
